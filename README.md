...
* [5种必知的大数据处理框架技术](https://www.cnblogs.com/oc-bowen/p/6109009.html)
...
* [元数据 - 百度百科](https://baike.baidu.com/item/%E5%85%83%E6%95%B0%E6%8D%AE/1946090?fr=aladdin)
...
* [Linux环境C语言dlopen加载so库文件提示undefined symbol问题](https://blog.csdn.net/boenxia/article/details/89475501)
* [dlmopen and C++ libraries](https://stackoverflow.com/questions/55008283/dlmopen-and-c-libraries)
...
### 单元测试
* C++: btest
* Java: 手动mvn test，自动jenkins
* Python: unittest

### 覆盖率
* Java：JaCoCo、JCov、OpenClover、EclEmma
* Python：[python代码覆盖率coverage简介与用法](https://www.cnblogs.com/sunshine-blog/p/9815088.html)
* Python：[聊聊 Python 代码覆盖率工具 - Coverage](https://www.jianshu.com/p/17521a50eeb5)
* C++：Bullseye
...
* [EBGP/IBGP/IGP有何区别？](https://blog.csdn.net/doraemonhall/article/details/38381263)
* [数据中心网络等价多路径（ECMP）技术应用研究](https://www.ruijie.com.cn/fa/xw-hlw/82104/)
* [深入看ECMP(详解其实现机制)](https://blog.csdn.net/aiaiai010101/article/details/84673687)
* [浅析ECMP等价路由](https://blog.csdn.net/aiaiai010101/article/details/84661302)
* [老鼠流 大象流定义？](https://www.zhihu.com/question/50171430/answer/371316260)
* [浏览器输入一个URL地址访问的全过程](https://blog.csdn.net/qq_39283195/article/details/100073969)
* [TCP—-SYN、ACK-、FIN、RST、PSH、URG-详解](https://blog.csdn.net/lamb7758/article/details/89147474)
* [TCP的三次握手与四次挥手理解及面试题（很全面）](https://www.cnblogs.com/bj-mr-li/p/11106390.html)
* [卧槽！牛皮了，头一次见有大佬把TCP/IP三次握手四次挥手解释的这么明白 - 爱前端不爱恋爱的文章 - 知乎](https://zhuanlan.zhihu.com/p/141396896)
* [TCP协议的RST标志位 - jasonj333的文章 - 知乎](https://zhuanlan.zhihu.com/p/361714600)
* [图解ARP协议（一） - 拼客学院陈鑫杰的文章 - 知乎](https://zhuanlan.zhihu.com/p/28771785)
* [SNMP 已死 - Streaming Telemetry 流遥测技术](https://blog.51cto.com/gingerbeer/2287783)
* [数据中心网络监控小结](https://www.cnblogs.com/dream397/p/12938096.html)
* [云网络丢包故障定位](https://mp.weixin.qq.com/s/-Q1AkxUr9xzGKwUMV-FQhQ)
* [为什么以太网mtu值被设定为1500?](https://www.zhihu.com/question/31460305?sort=created)
* [BGP中IBGP和EBGP的区别和联系](https://blog.csdn.net/zhouwei1221q/article/details/45420223)
* [TCP包头详解](https://blog.csdn.net/wdirdo/article/details/99706085)
* [三大运营商中国电信，移动，联通之间是如何用BGP来解决不同AS间通信的？](https://blog.csdn.net/Lihuihui006/article/details/107756764)
* [数据中心网络架构浅谈（一）](https://zhuanlan.zhihu.com/p/29881248)
* [高性能数据中心网络的流量收敛设计](http://blog.sina.com.cn/s/blog_61bd83dc01018daj.html)
* [网络设计中采用的过载(Oversubscription)设计模式，计算过程有些不理解](https://zhidao.baidu.com/question/579851240.html)
* [IP地址分类（A类 B类 C类 D类 E类）](https://www.cnblogs.com/tunian/p/9632893.html)
* [既然已经有了BGP为什么还需要OSPF与RIP这一类IGP？](https://www.zhihu.com/question/411029743)
* [BGP AS-Path](http://blog.sina.com.cn/s/blog_c4b6d0b80102vzq7.html)
...
* [Linux TOP CPU %wa 值的理解](https://blog.csdn.net/luojiusan520/article/details/104875709)
* [性能案例分析 | 磁盘IO瓶颈分析 ](https://www.cnblogs.com/wyf0518/p/12213999.html)
* [关于磁盘性能（IO）瓶颈](https://blog.csdn.net/u013066730/article/details/82757473)
...
* [Linux下cp命令 -f无效的解决方法](https://blog.csdn.net/carolzhang8406/article/details/41347829)
* [fetchmail: SMTP error: 552 5.3.4 Message size exceeds fixed limit](http://blog.sina.com.cn/s/blog_7edf8b9f0100to4p.html)
* [Name Service Switch configuration file](https://linux.die.net/man/5/nss)
...
* iptables -L -t mangle 查看DSCP标签配置
* arp -h 查看arp信息
* 格式化输出printf代替echo
* tr -d可以快速删除字符，也可以tr [options] source-char-list replace-char-list
* -n检查语法不执行，-x跟踪脚本执行详情，也可以在脚本中使用set -x打开跟踪开关 ，set +x关闭
单个+号表示执行的语句，两个+号表示子shell中执行，shell的函数都在子shell中执行。
* if grep  pattern file > /dev/null可以代替-s -q选项，测试其他命令退出状态也可以使用此方法
* stty -echo; read pass < /dev/tty; stty echo可以关闭回显并读取密码
* cat > new_file; echo > new_file; touch new_file都可以创建新文件
* 内存 - free，-m以M为单位显示
...
## 词汇
> 历史债务与新的挑战  
顶层设计，统一平台，资源共享，技术同栈，组织保障  
长尾效应，取舍平衡，后发优势，定位差异  
稳定性、产品化、质量、前沿调研  
强相关与弱相关  
没有银弹！
性能提升，成本节约，开发成本，代码复杂度，运维成本  
随机读写，顺序读写  
exactly once，at least once  
CPU密集型，内存密集型，网络密集型，存储密集型  
运营指标  
清晰定义，输出文档，评审归档  
...
control 控制  
burst 爆发  
bad case、flow、topology 恶性事件、流量、拓扑  
undefined 待定   
gentle 温和   
aggressive 激进   
factor
...
* [你真的会“提、打、挺、松”吗？掌握正确的口腔训练，让你的吐字清晰、字正腔圆！ - 刘玥教育的文章 - 知乎](https://zhuanlan.zhihu.com/p/407721089)
* [为什么唱歌词拖的时间较长时，就会变成韵母的发音，而声母就不发音了？其他语言的歌词会有这个现象吗？ - 欧歌啊的回答 - 知乎](https://www.zhihu.com/question/274366535/answer/379210807)
* [【教学】播音系师哥帮你纠正语音问题！前后鼻音？平翘舌？l、n不分？不存在的！](https://www.bilibili.com/video/BV1wE41117AB?share_source=copy_web)
...
* [如何评价歌手任然？ - 知乎](https://www.zhihu.com/question/48375251)

## 其他
> 针对不同业务场景制定可用性目标：无人车场景需要远超99.999%（年故障时间5分钟），云业务99.999%足够

> 每个设备独立线程，内存消耗4M，1000个设备4G，考虑内存消耗；秒级采集，对CPU来说是long time，不用考虑CPU压力  
SQL计算网络密集型和CPU密集型，线程数量设置为CPU数量或者CPU*2或3  
流式计算，网络密集型；doris，CPU密集

> 结构化数据与非结构化数据差异，系统间交互数据尽量结构化，除非特殊场景考虑性能提升  
proto文件省略key字段内容传输，client和server端都进行存储结构，序列化与反序列化，压缩与解压
